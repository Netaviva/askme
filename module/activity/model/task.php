...
class Activity_Model_Task extends Linko_Model
{
	...
	public function activity_add_blog_post($iId, $aFeed)
	{
		$aPost = Linko::Model('Blog')->getPost($iId);
		...
		$sText = Lang::t('activity.added_a_new_blog_bloglink', array(
			'blog_link'	=> Html::link($aPost['post_title'], Linko::Url()->make('blog:entry', array('slug' => $aPost['post_slug'])))
		));
